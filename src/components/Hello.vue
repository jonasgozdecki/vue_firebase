	...
	<div class="container-fluid">
		<div class="jumbotron hero">
				...
				<div class="container">
					<div id="navbar" class="navbar navbar-nav navbar-static-top">
						<ul class="nav navbar-default navbar-right">
							...
							<li><a href="#" v-on:click="plan" >Planos</a></li>
			...
			<div class="text-center hero-row">
				...
				<div class="btn-group">
					<button class="btn btn-lg btnx-blue" type="button" v-on:click="developerArea">Designer</button>
					<button class="btn btn-lg btnx-white" type="button" v-on:click="customerArea">Cliente</button>
				</div>
			</div>
			<div class="container">
...
.jumbotron.hero {
	...
	margin: 0;
	padding: 0;
	background-image: url(../assets/images/bg_home.jpg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940);
